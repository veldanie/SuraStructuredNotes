bs_lookback_disc <-
function (spot, strike, m,  v, r, rf, t, c_p = "call", float_strike=1, sample=100, rate_type="nominal"){
    ...
    beta=0.5826
    alpha=exp(cp*beta*v*sqrt(t/sample))
    price_lookback_disc=price_lookback/alpha
    return(price_lookback_disc)
  }
